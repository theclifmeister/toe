...
# where it is, covered, and the tiles start under the bar; SUPER+SHIFT+SPACE takes the bar away
# to show the menu bar — which is how you reach an application's menus by mouse — and again to
# bring it back. Off by default: the workspace strip is a menu bar item until you ask for the
